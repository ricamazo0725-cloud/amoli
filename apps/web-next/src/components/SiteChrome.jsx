...
// Equivalente a components/Layout.jsx del proyecto Vite: header + barra
// animada + menú + carrito + footer. Solo se usa en las rutas de la tienda
// pública (app/(shop)/layout.js) — el panel /admin no lo usa, igual que en
// el proyecto original (App.jsx renderizaba /admin/* fuera de <Layout>).
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <header className="sticky top-0 z-40 border-b-2 border-foreground bg-background/95 backdrop-blur">
        <div className="mx-auto flex max-w-[90rem] items-center justify-between px-4 py-4 sm:px-8">
          ...
          <Link href="/" className="font-display text-4xl sm:text-5xl font-black leading-none tracking-tighter transition-colors hover:text-primary">
            AMOLI
          </Link>
