...
export function useGoogleMapsScript() {
  ...
  // SSR-safe: `window` no existe en el servidor de Next.js — el valor real
	// se confirma en el useEffect de abajo, que solo corre en el navegador.
	const [isLoaded, setIsLoaded] = useState(false);
  const [loadError, setLoadError] = useState(
    apiKey ? null : new Error('Falta NEXT_PUBLIC_GOOGLE_MAPS_API_KEY en el .env')
  );
