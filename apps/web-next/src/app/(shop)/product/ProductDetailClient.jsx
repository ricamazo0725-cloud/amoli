...
/** @param {{ product: Object }} props - el producto ya viene cargado desde el servidor (generateMetadata / page.js ya lo necesitaba de todas formas) */
const ProductDetailClient = ({ product }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <Link href="/productos" className="inline-flex items-center gap-2 text-foreground hover:text-primary transition-colors mb-6">
        <ArrowLeft size={16} />
        Volver a la tienda
      </Link>
